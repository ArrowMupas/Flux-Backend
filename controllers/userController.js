...
const verifyEmail = asyncHandler(async (req, res) => {
    ...
    await userModel.verifyUser(user.id); // Set is_verified = true
    await userModel.deleteVerificationToken(token); // Optional cleanup
...
const resendVerificationEmail = asyncHandler(async (req, res) => {
    ...
    if (user.is_verified) {
        // Adjust according to your user schema property
    ...
    // Save new verification token to DB (update or insert)
    await userModel.saveVerificationToken(user.id, verificationToken);
