...
const createWalkInSale = async (name, email, items, discount_amount = 0, notes = '') => {
    ...
    try {
        ...
        for (const item of items) {
            // Fetch unit_price from DB for each product
            ...
            // Insert sale item with correct price and subtotal
        ...
        // 3. Update total_amount now that all items processed and subtotal calculated
